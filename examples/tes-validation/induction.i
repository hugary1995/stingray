...
sigma_graphite = 2.5e5 # S/m, 2~3e5 perpendicular to the basal plane
sigma_coil = 6e5 # S/m, Note copper conductivity is around 6e7, but induction coil is hollow with water coolant running through

# frequency
f = 100000
omega = '${fparse 2*pi*f}'

non_coil = 'susceptor crucible air'
...
[Functions]
  ...
  [P]
    ...
    data_file = 'gold/exp${schedule}_processed.csv'
    x_title = 'Time (sec)'
    y_title = 'Power (W)'
    format = columns
  []
...
[Materials]
  ...
  [p]
    ...
    constant_expressions = '4 0.07 0.025 0.003'
